...
\begin{rmk}\label{rmk:gap}
    \underline{以下の証明(具体的には補題\ref{lem:proof_of_pl})は1つだけごまかし(ギャップ)を含んでいる}が，ここでは次の理由によって完全ではない証明を紹介する：・関数の可測性にかんするギャップであり(注意\ref{rmk:measurability}を見よ)，はっきり言って非本質的である・証明を修正しようとすると(少なくとも筆者が検討した限り)仮定を弱めるか定理のreformulationが必要となり，労力を要する．
